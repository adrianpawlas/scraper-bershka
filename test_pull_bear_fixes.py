...
async def test_category_scraping():
    ...
    try:
        ...
        async with BershkaScraper() as scraper:
            ...
            product_ids_url = await load_product_ids_from_url_async(test_category_id, scraper.category_urls)
...
async def main():
    ...
    if success:
        print("\n🎉 Bershka scraper fixes verified successfully!")
    else:
        print("\n💥 Bershka scraper fixes have issues that need attention.")
        sys.exit(1)
